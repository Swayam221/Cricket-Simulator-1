...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Location = System::Drawing::Point(62, 46);
			...
			this->label7->Location = System::Drawing::Point(62, 148);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 t3=t3->Trim();
				 if (!(t3->IsNullOrEmpty(t3) || t3->IsNullOrWhiteSpace(t3) || t3->Equals("0")))
				 {
					 label6->Text = "";
					 ...
					 if ((t1->Equals("CSK") || t1->Equals("MI") || t1->Equals("DC") || t1->Equals("KKR") || t1->Equals("RR") || t1->Equals("RCB") || t1->Equals("KXIP") || t1->Equals("SRH"))
						 && (t2->Equals("CSK") || t2->Equals("MI") || t2->Equals("DC") || t2->Equals("KKR") || t2->Equals("RR") || t2->Equals("RCB") || t2->Equals("KXIP") || t2->Equals("SRH")))
					 {
						 ...
						 label7->Text = "please enter valid team name";
				 }
				 else
				 {
					 label6->Text = "please enter no. of matches";
